	...
	<div class="main">
        ...
        <div style="border: 1px solid #ccc; border-radius: 3px; padding: 5px; display: inline-block">
            <form method="post" id="form">
                <input style="padding: 10px; margin: 0; min-height: 20px;" value="<?php echo getInputAsString($input);?>">
                ...
                <table style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control" type="submit" name="zero" value="00"/></td>
                        <td><input class="form-control" type="submit" name="." value="."/></td>
                        <td><input class="form-control" type="submit" name="add" value="+"/></td>
                    </tr>
                    <tr>
                        <td colspan=2><input  class="form-control" type="submit" name="c" value="C"/></td>
                        <td colspan=2><input  class="form-control" type="submit" name="equal" value="="/></td>
                    </tr>
                </table>
            </form>
        </div>
